...
{
    [TestMethod]
    public void Subtract_Valid_Haupt()
    {
    ...
    [TestMethod]
    public void Subtract_Invalid_Haupt()
    {
    ...
    [TestMethod]
    public void Subtract_Null_Haupt()
    {
...
{
    [TestMethod]
    public void Multiply_Valid_Haupt()
    {
    ...
    [TestMethod]
    public void Multiply_Invalid_Haupt()
    {
    ...
    [TestMethod]
    public void Multiply_Null_Haupt()
    {
...
{
    [TestMethod]
    public void Divide_Valid_Haupt()
    {
        Assert.AreEqual(0.5, Program.Divide("1", "2"));
        Assert.AreEqual(1.5, Program.Divide("3", "2"));
        Assert.AreEqual(0.7142857142857143, Program.Divide("5", "7"), 1e-10);
    }

    [TestMethod]
    public void Divide_Invalid_Haupt()
    {
...
{
    [TestMethod]
    public void Power_Valid_Haupt()
    {
        Assert.AreEqual(8, Program.Power("2", "3"));
        Assert.AreEqual(1, Program.Power("5", "0"));
        Assert.AreEqual(0.25, Program.Power("2", "-2"), 1e-10);
    }

    [TestMethod]
    public void Power_Invalid_Haupt()
    {
